...
import 'package:flutter_training/valcurs.dart';
...
const apiCategory = {
 ...
 Map<String, Map<String, String>> apiCategories = {
   'flutter' :  {
'name': 'Currency',
'route': 'currency',
},
...
class Api implements GetUnits{
  ...
  Future<double> convert(
     String amount, String fromUnit, String toUnit) async {
